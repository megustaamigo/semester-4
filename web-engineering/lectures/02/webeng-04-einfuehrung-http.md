...
**Lernziele:** [[web-engineering/lernziele/webeng-lernziele-02|Lernziele Vorlesung 2]]


## Inhaltsverzeichnis

- [[#HTTP — Hypertext Transfer Protocol|HTTP — Hypertext Transfer Protocol]]
- [[#Adressierung: URI, URL, URN|Adressierung: URI, URL, URN]]
- [[#HTTP im OSI-Modell|HTTP im OSI-Modell]]
- [[#Client-Server-Modell|Client-Server-Modell]]
- [[#HTTP Ablauf|HTTP Ablauf]]
- [[#Request und Response — Formaler Aufbau|Request und Response — Formaler Aufbau]]
...
HTTP ist ein Anwendungsprotokoll (Schichten 5-7 im OSI-Modell), basiert auf TCP (Schicht 4) und IP (Schicht 3). Siehe [[kommunikationssysteme/komsys-index|Kommunikationssysteme]].
...
## Bezug zu [[web-engineering/lernziele/webeng-lernziele-02|Lernzielen]]
