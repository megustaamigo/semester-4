...
**Lernziele:** [[web-engineering/lernziele/lernziele-03|Lernziele Vorlesung 3]]
...
> **Merke:** Ein Cookie kann **nicht im selben Skriptdurchlauf** gespeichert und gelesen werden. Das Cookie wird erst beim nächsten Client-Request im `$_COOKIE`-Array verfügbar.
