...
- [[#Der Begriff Netzwerk|Der Begriff Netzwerk]]
- [[#Implementierung von Datenkommunikation|Implementierung von Datenkommunikation]]
- [[#Systemschichtung|Systemschichtung]]
- [[#Standardisierung der Protokolle|Standardisierung der Protokolle]]
- [[#Das ISO-OSI-Referenzmodell (7 Schichten)|Das ISO-OSI-Referenzmodell (7 Schichten)]]
- [[#Aufgaben der einzelnen OSI-Schichten|Aufgaben der einzelnen OSI-Schichten]]
- [[#Schichtenmodelle in der Praxis: TCP/IP|Schichtenmodelle in der Praxis: TCP/IP]]
- [[#Fazit|Fazit]]
...
> [!tip] Merke
> Die Anwendungsschicht ist eher als Bibliothek zu verstehen — es sind **nicht die Anwendungen selber**
...
> [!tip] Merke
> Die Sitzungsschicht regelt den elementaren Kommunikationsablauf
...
> [!tip] Merke
> Die Transportschicht ermoeglicht die Kommunikation zwischen Anwendungen/Prozessen!
...
> [!tip] Merke
> Die Vermittlungsschicht ermoeglicht die Kommunikation zwischen Endgeraeten ueber Netzwerkgrenzen hinweg!
...
> [!tip] Merke
> Die Sicherungsschicht ermoeglicht die Kommunikation zwischen Rechnern in einem einzelnen Netz und regelt ggf. den konfliktfreien Mehrfachzugriff
...
> [!tip] Merke
> Regelt die Darstellung von Symbolen (Bits) und die Kabel/Drahtlos-technik
...
> [!tip] Merke
> Waehrend das ISO/OSI-Modell systematisch die Abstraktionsebenen festlegt, geht das Internet-Referenzmodell einen pragmatischen Weg:
...
## Fragen zur [[kommunikationssysteme/selbstkontrolle/komsys-selbstkontrolle-01|Selbstkontrolle]]
